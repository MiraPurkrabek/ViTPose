...
prtr = None
load_from = "models/my/blackout_unfreeze_epoch_37.pth"
...
model = dict(
    ...
    keypoint_head=dict(
        type='TopdownHeatmapProbSimpleHead',
        in_channels=384,
        num_deconv_layers=2,
        ...
        loss_keypoint=dict(type='JointsMSEProbLoss', use_target_weight=True),
        normalize=False,
        freeze_kpt_head=True),
    train_cfg=dict(),
    test_cfg=dict(
        flip_test=True,
