...
prtr = None
# load_from = "models/my/full_zeros_epoch_50.pth"
load_from = "work_dirs/ViTPose_small_coco_256x192_full_blackout_zeros_finetune_attach/best_AP_epoch_30.pth"
...
model = dict(
    ...
    keypoint_head=dict(
        ...
        loss_probability=dict(type='BCELoss', use_target_weight=False, loss_weight=1.0),
