NEW_COCO_ROOT = "/datagrid/personal/purkrmir/data/SyntheticPose/PERIMETER_synthetic/"
ORIGINAL_COCO_ROOT = "/datagrid/personal/purkrmir/data/COCO/original"
BATCH_SIZE = 8

# load_from = "models/pretrained/mae_pretrain_vit_large.pth"
load_from = "work_dirs/ViTPose_large_simple_PERIMETER_synthetic_256x192_backup/epoch_10.pth"
...
optimizer = dict(type='AdamW', lr=6e-5, betas=(0.9, 0.999), weight_decay=0.1,
...
data = dict(
    ...
    train=dict(
        ...
        ann_file=f'{ORIGINAL_COCO_ROOT}/annotations/person_keypoints_train2017.json',
        img_prefix=f'{ORIGINAL_COCO_ROOT}/train2017/',
        data_cfg=data_cfg,
