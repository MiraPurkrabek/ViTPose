...
class TopdownHeatmapFullVisHead(TopdownHeatmapBaseHead):
    ...
    def __init__(self,
        ...
        self.detach_prob_head = detach_prob_head
    ...
    def get_loss(self, output, target, target_weight, reduction='mean'):
        ...
        # noise_mask = ((pred_errors / target_errors) < 0.5 )
        # noise_mask = noise_mask.float() * (target_probs > 0).float()
        ...
        losses['heatmap_loss'] = self.keypoint_loss(pred_heatmaps, target_heatmaps, heatmap_weight)
