...
CFG="configs/body/2d_kpt_sview_rgb_img/topdown_heatmap/coco/ViTPose_small_coco_256x192_heatmap_w_prob_frozen.py"
# CFG="configs/body/2d_kpt_sview_rgb_img/topdown_heatmap/coco/ViTPose_small_coco_256x192_probabilitymap_w_JSD_loss_frozen_ViT.py"
# CFG="configs/body/2d_kpt_sview_rgb_img/topdown_heatmap/coco/ViTPose_small_coco_256x192_4probabilitymap_w_JSD_loss_frozen_ViT.py"
...
# WEIGHTS="work_dirs/ViTPose_small_coco_256x192_probabilitymap_w_loss/best_AP_epoch_208.pth"
# WEIGHTS="work_dirs/ViTPose_small_coco_256x192_probabilitymap_w_JSD_loss_frozen_ViT_blackout/best_AP_epoch_16.pth"
# WEIGHTS="work_dirs/ViTPose_small_coco_256x192_probabilitymap_w_JSD_loss_frozen_ViT/best_AP_epoch_19.pth"
# WEIGHTS="work_dirs/ViTPose_small_coco_256x192_4probabilitymap_w_JSD_loss_frozen_ViT/best_AP_epoch_19.pth"
WEIGHTS="work_dirs/ViTPose_small_coco_256x192_heatmap_w_prob_frozen/best_AP_epoch_72.pth"
# WEIGHTS="work_dirs/ViTPose_small_coco_256x192_heatmap_frozen_w_prob/epoch_210_finetune.pth"
